...
export class ToolsComponent implements OnInit {
  ...
  constructor(private apiService: ApiService, private router: Router, private sharing: SharingService) { }

  ngOnInit(): void {
  }

  getFilmListFromShowtimeComponent() {
    this.subFilmList = this.sharing.sharingFilmListFromShowtimeComponent.subscribe((data: any) => {
      if (data != null) {
        this.movies = data;
      }
    })
  ...
  getDateFromAPI() {
    ...
    this.subFilmDetail = this.apiService.get(uri).subscribe((data: any) => {
      if (data != null) {
        this.movie = data;
      }
    })
